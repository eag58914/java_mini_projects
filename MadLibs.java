public class MadLibs {
    /*
     * This program generates a mad libbed story. Author: Elco
     */
    public static void main(String[] args) {
        String name1 = "Arthur";
        String adjective1 = "hungry";
        String adjective2 = "food";
        String adjective3 = "big";
        String verb1 = "drop";
        String noun1 = "library";
        String noun2 = "Disneyland";
        String noun3 = "love child";
        String noun4 = "balloon";
        String noun5 = "band";
        String noun6 = "knife";
        String name2 = "Billy Bob";
        int number = 69;
        String place1 = "Yo momma";
